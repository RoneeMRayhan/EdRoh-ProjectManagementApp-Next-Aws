  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://pm-s3-images13.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://pm-s3-images13.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-s3-images13.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
          ...
          <div className="flex items-center text-gray-500 dark:text-neutral-500">
            ...
            <span className="ml-3 text-sm dark:text-neutral-400">
              {numberOfComments}
            </span>
          </div>
        </div>
